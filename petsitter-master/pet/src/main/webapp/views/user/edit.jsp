...
<body class="subpage">
	<form action="${pageContext.request.contextPath}/user/edit"
		...
		<div class="test">
			<c:forEach items="${user}" var="User" varStatus="sts">
				<form class="form=horizontal">
					<div class="col-sm-10">
						<img width="200px" height="200px" alt="사진출력부분"
							title="profileimage" />
					</div>
					<div class="col-sm-10">
						<label for="uName" class="col-sm-2 control-label">파일 업로드</label> <input
				...
				<div class="button">
					<a
						href="${pageContext.request.contextPath}/user/edit.do?uId=${user.uId}">수정</a> <a
						href="${pageContext.request.contextPath}/user/delete.do?uId=${user.uId}">탈퇴</a>
				</div>
			</c:forEach>
		</div>
